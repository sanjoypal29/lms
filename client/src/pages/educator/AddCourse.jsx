   ...
   const handleChapter=(action,chapterId)=>{
    ...
    setChapters(chapters.filter((chapter)=>chapter.chapterId!==chapterId));
     ...
     setChapters(chapters.map((chapter)=>{
      ...
      return  chapter.chapterId===chapterId ? {...chapter,collapsed:!chapter.collapsed} : chapter;
     }));
  }
}
...
const handleSubmit=async(e)=>{
  ...
  return (
    ...
    <div className='flex md:flex-row flex-col items-center gap-3'>
      ...
      {/* Adding chapters and lectures will go here */}
      <div>
        {chapters.map((chapter,chapterIndex)=>(
          <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
            <div className='flex justify-between items-center p-4 border-b'>
     <div className='flex items-center'>
    <img src={assets.dropdown_icon} alt="chapter_icon" width={14} className={`mr-2 cursor-pointer transition-all ${chapter.collapsed && "rotate-90"} `} onClick={() => handleChapter('toggle', chapter.chapterId)}/> 
